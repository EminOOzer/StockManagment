...
namespace sttok.Migrations
{
    ...
    [Migration("20250602063655_AddKullaniciAdiToStokHareket")]
    partial class AddKullaniciAdiToStokHareket
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("sttok.Models.DepoStok", b =>
                {
            ...
            modelBuilder.Entity("sttok.Models.Product", b =>
                {
                    b.Property<int>("UrunId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("UrunBoy")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)");

                    b.Property<string>("UrunCesit")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("UrunDesenKod")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<decimal>("UrunEn")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)");
            ...
            modelBuilder.Entity("sttok.Models.StokHareket", b =>
                {
            ...
            modelBuilder.Entity("sttok.Models.DepoStok", b =>
                {
                    b.HasOne("sttok.Models.Product", "Product")
                        .WithMany()
